...
var marker = L.marker([34.05212420088591, -118.25245573522596],
    {alt:"Scientology, Los Angeles, Stati Uniti"}).addTo(map).bindPopup("<a href='scientology-mappa.html'><strong>Scientology</strong></a><br>Los Angeles, California, Stati Uniti");

var marker = L.marker([37.77097037105978, -122.41975172507638],
    {alt: "Famiglia Manson, San Francisco, Stati Uniti"}).addTo(map).bindPopup("<a href='famiglia-manson-mappa.html'><strong>Famiglia Manson</strong></a><br>Contea di San Francisco, California, Stati Uniti");
